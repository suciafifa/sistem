...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('template1/img/core-img/favicon.ico')}}">

    <!-- Core Stylesheet -->
    <link rel="stylesheet" href="{{asset('template1/style.css')}}">

    <link rel="stylesheet" href="{{asset('template3/css/linearicons.css')}}">
            <link rel="stylesheet" href="{{asset('template3/css/font-awesome.min.css')}}">
            <link rel="stylesheet" href="{{asset('template3/css/bootstrap.css')}}">
            <link rel="stylesheet" href="{{asset('template3/css/magnific-popup.css')}}">
            <link rel="stylesheet" href="{{asset('template3/css/nice-select.css')}}">                      
            <link rel="stylesheet" href="{{asset('template3/css/animate.min.css')}}">
            <link rel="stylesheet" href="{{asset('template3/css/owl.carousel.css')}}">         
            <link rel="stylesheet" href="{{asset('template3/css/jquery-ui.css')}}">            
            <link rel="stylesheet" href="{{asset('template3/css/main.css')}}">
...
<body>
                    ...
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            <div class="academy-logo">
                                <a href="index.html"><img src="{{asset('template1/img/core-img/logo.png')}}" alt=""></a>
                            </div>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url({{asset('template1/img/bg-img/ks.jpg')}});">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                
                                <h2 data-animation="fadeInUp" data-delay="400ms">Wellcome to SMK Maskumambang</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url({{asset('template1/img/bg-img/sm.jpg')}});">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- jQuery-2.2.4 js -->
    <script src="{{asset('template1/js/jquery/jquery-2.2.4.min.js')}}"></script>
    <!-- Popper js -->
    <script src="{{asset('template1/js/bootstrap/popper.min.js')}}"></script>
    <!-- Bootstrap js -->
    <script src="{{asset('template1/js/bootstrap/bootstrap.min.js')}}"></script>
    <!-- All Plugins js -->
    <script src="{{asset('template1/js/plugins/plugins.js')}}"></script>
    <!-- Active js -->
    <script src="{{asset('template1/js/active.js')}}"></script>

    <script src="{{asset('template3/js/vendor/bootstrap.min.js')}}"></script>          
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
            <script src="{{asset('template3/js/easing.min.js')}}"></script>            
            <script src="{{asset('template3/js/hoverIntent.js')}}"></script>
            <script src="{{asset('template3/js/superfish.min.js')}}"></script> 
            <script src="{{asset('template3/js/jquery.ajaxchimp.min.js')}}"></script>
            <script src="{{asset('template3/js/jquery.magnific-popup.min.js')}}"></script> 
            <script src="{{asset('template3/js/jquery.tabs.min.js')}}"></script>                       
            <script src="{{asset('template3/js/jquery.nice-select.min.js')}}"></script>    
            <script src="{{asset('template3/js/owl.carousel.min.js')}}"></script>
            <script src="{{asset('template3/js/mail-script.js')}}"></script>   
            <script src="{{asset('template3/js/main.js')}}"></script>
